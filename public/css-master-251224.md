...
今日はこの「CSS ロジック」を楽しみましょう！

---

### はじめに：「チェックボックス・ハック」という魔法
...
これを **「Checkbox Hack（チェックボックス・ハック）」** と呼びます。古くからある技術ですが、最近の CSS の進化により、アニメーションの滑らかさが劇的に向上しました。
...
```css
/* inputがチェックされたら、その後ろにある content を操作 */
