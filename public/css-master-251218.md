...
Phase 3 も後半戦。今日は CSS の書き方を根本から変える「CSS 変数」です。
...
3.  **ダークモード**: CSS 変数の値を上書きするだけで、サイトの配色を切り替える。
...
次回は、JavaScript を使わずにリッチなスライダーを作る **「スクロールスナップ」** です。
